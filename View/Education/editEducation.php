...
<?php
include('/xampp/htdocs/PSW-SEM3/Payroll/Model/educationController.php')
?>

<body style=" font-family: Questrial, sans-serif !important;" class="bg-warning">
    <div class="container mb-5">
        <h3 class="text-center font-weight-bold mt-5 mb-3">Edit Education Info</h3>
        <!-- change below -->
        <form action="../../Model/educationController.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="education_term" value="<?= $education_term ?>" class="form-control" placeholder="Education Term" required>
            </div>
            <div class="d-flex justify-content-center mt-4">
                <button type="submit" name="submitEditEducation" class="btn btn-secondary w-50">Submit</button>
            </div>
