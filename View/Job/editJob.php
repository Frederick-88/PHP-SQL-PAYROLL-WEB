...
<?php
include('/xampp/htdocs/PSW-SEM3/Payroll/Model/jobController.php')
?>

<body style=" font-family: Questrial, sans-serif !important;" class="bg-warning">
    <div class="container mb-5">
        <h3 class="text-center font-weight-bold mt-5 mb-3">Edit Job Info</h3>
        <!-- change below -->
        <form action="../../Model/jobController.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="job_label" value="<?= $job_label ?>" class="form-control" placeholder="New Job Label" required>
            </div>
            <div class="d-flex justify-content-center mt-4">
                <button type="submit" name="submitEditJob" class="btn btn-secondary w-50">Submit</button>
            </div>
